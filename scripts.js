        ...
        searchInput.addEventListener('input', () => {
            ...
            if (results.length > 0) {
                ...
                resultsContainer.classList.remove('hidden'); // Show results container
                 ...
                 // FIX: No results found. Hide the (empty) results container and show the nav grid again.
                 resultsContainer.innerHTML = ''; // Clear any content
                 resultsContainer.classList.add('hidden'); // Hide the results dropdown
                 showNav(true); // Show the main navigation grid
            }
        });
